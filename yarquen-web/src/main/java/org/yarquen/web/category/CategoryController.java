...
public class CategoryController {
	...
	public void addcategory(@RequestParam("parent") String parentCategory,
			@RequestParam("child") String childCategory, HttpServletResponse rsp)
			throws IOException {
		final CategoryBranch categoryBranch = CategoryBranch
				.parse(parentCategory);
		LOGGER.debug("adding category {} to parent {}", childCategory,
				categoryBranch);
		try {
			String code = categoryService.addCategory(categoryBranch,
					childCategory);
	...
	public void addcategoryFake(@RequestParam("parent") String parentCategory,
			@RequestParam("child") String childCategory) {
		LOGGER.debug("adding category {} to parent {}", childCategory,
				parentCategory);
	}

	@RequestMapping(value = "/renameCategory", method = RequestMethod.GET)
	public void renameCategory(@RequestParam("branch") String branch,
			@RequestParam("newName") String newName, HttpServletResponse rsp)
			throws IOException {
	...
	@ResponseStatus(HttpStatus.OK)
	public void renameCategoryFake(@RequestParam("branch") String branch,
			@RequestParam("newName") String newName) {
		LOGGER.debug("renaming category branch {} with {}", branch, newName);
	}

	@RequestMapping(value = "/removeCategory", method = RequestMethod.GET)
	public void removeCategory(@RequestParam("branch") String branch,
